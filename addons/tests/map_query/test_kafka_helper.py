...
import os
from images.map_query import kafka_helper
...
@patch("images.map_query.kafka_helper.KafkaConsumer")
def test_create_consumer_confluent(mock_kafkaConsumer):
...
@patch("images.map_query.kafka_helper.KafkaConsumer")
def test_create_consumer_without_confluent(mock_consumer):
    mock_instance = MagicMock()
