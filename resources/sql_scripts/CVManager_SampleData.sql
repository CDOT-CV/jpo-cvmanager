...
INSERT INTO
    public.rsu_credentials(username, password, nickname)
VALUES (
        'username',
        'password',
        'cred1'
...
INSERT INTO
    public.snmp_credentials(username, password, nickname)
VALUES (
        'username',
        'password',
        'snmp1'
...
INSERT INTO
    public.snmp_versions(version_code, nickname)
VALUES ('4.1', '4.1');
...
INSERT INTO
    public.rsu_organization(rsu_id, organization_id)
VALUES (1, 1);
...
ADD
    snmp_version_id integer NOT NULL DEFAULT (1);