...
class UserObjectTest {
    ...
    void fromJoinedResultSet() throws SQLException {
        ...
        assertThat(userObject.getOrganizations().get(0).getOrgId(), is(1));
        assertThat(userObject.getOrganizations().get(0).getOrgName(), is("test org 1"));
        assertThat(userObject.getOrganizations().get(0).getOrgEmail(), is("email1"));
        assertThat(userObject.getOrganizations().get(0).getRole(), is("test role 1"));
        assertThat(userObject.getOrganizations().get(1).getOrgId(), is(2));
        assertThat(userObject.getOrganizations().get(1).getOrgName(), is("test org 2"));
        assertThat(userObject.getOrganizations().get(1).getOrgEmail(), is("email2"));
    ...
    void toTokenMap() {
        ...
        assertThat((((List<Map<String, Integer>>) tokenMap.get(Constants.ORGANIZATIONS_KEY)).get(0)).get("org_id"),
                is(1));
        assertThat((((List<Map<String, String>>) tokenMap.get(Constants.ORGANIZATIONS_KEY)).get(0)).get("org_name"),
                is("test org 1"));
        assertThat((((List<Map<String, String>>) tokenMap.get(Constants.ORGANIZATIONS_KEY)).get(0)).get("org_email"),
                is("email1"));
        assertThat((((List<Map<String, String>>) tokenMap.get(Constants.ORGANIZATIONS_KEY)).get(0)).get("role"),
                is("test role 1"));
        assertThat((((List<Map<String, Integer>>) tokenMap.get(Constants.ORGANIZATIONS_KEY)).get(1)).get("org_id"),
                is(2));
        assertThat((((List<Map<String, String>>) tokenMap.get(Constants.ORGANIZATIONS_KEY)).get(1)).get("org_name"),
                is("test org 2"));
        assertThat((((List<Map<String, String>>) tokenMap.get(Constants.ORGANIZATIONS_KEY)).get(1)).get("org_email"),
                is("email2"));
