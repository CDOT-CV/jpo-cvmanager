...
- GCP project and service account with permission to create secrets and to add, access, list, and destroy GCP Secret Manager versions (only required if STORAGE_TYPE is set to 'gcp')
