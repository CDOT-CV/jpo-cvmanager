...
class RsuCredentialControllerTest {
    ...
    void testCreateRsuCredential_Success()
            throws RsuCredentialManagementService.RsuCredentialAlreadyExistsException, EntityNotFoundException {
        // Arrange
        ...
        RsuCredentialController.RsuCredentialCreateRequest rsuCredentialCreateRequest = new RsuCredentialController.RsuCredentialCreateRequest(
        ...
        RsuCredentialDTO expected = new RsuCredentialDTO(mockRsuCredentialId, nickname, username, password,
                mockOrganizationId);
    ...
    @Test
    void testCreateRsuCredential_Failure_AlreadyExists()
        ...
        RsuCredentialController.RsuCredentialCreateRequest rsuCredentialCreateRequest = new RsuCredentialController.RsuCredentialCreateRequest(
                nickname, username, password, orgId);
        when(mockRsuCredentialManagementService.create(rsuCredentialCreateRequest))
                .thenThrow(RsuCredentialManagementService.RsuCredentialAlreadyExistsException.class);
        rsuCredentialController = new RsuCredentialController(mockRsuCredentialManagementService, rsuCredentialMapper);

        // Act & Assert
        assertThrows(RsuCredentialManagementService.RsuCredentialAlreadyExistsException.class,
                () -> rsuCredentialController.createRsuCredential(rsuCredentialCreateRequest));
    }

    @Test
    void testCreateRsuCredential_Failure_OrganizationNotFound()
            throws EntityNotFoundException, RsuCredentialManagementService.RsuCredentialAlreadyExistsException {
        // Arrange
        String nickname = "nickname";
        String username = "username";
        ...
        RsuCredentialController.RsuCredentialCreateRequest rsuCredentialCreateRequest = new RsuCredentialController.RsuCredentialCreateRequest(
                nickname, username, password, orgId);
        doThrow(EntityNotFoundException.class).when(mockRsuCredentialManagementService)
    ...
    void testGetByNickname_Success() throws EntityNotFoundException {
        ...
        RsuCredentialController.RsuCredentialGetRequest rsuCredentialGetRequest = new RsuCredentialController.RsuCredentialGetRequest(
                nickname);
        RsuCredentialDTO expected = new RsuCredentialDTO(mockRsuCredentialId, nickname, username, password,
                mockOrganizationId);
    ...
    void testGetByNickname_Failure_NotFound() throws EntityNotFoundException {
        ...
        // Act & Assert
        assertThrows(EntityNotFoundException.class,
                () -> rsuCredentialController.getByNickname(rsuCredentialGetRequest));
    }
    ...
    void testUpdate_Success() throws EntityNotFoundException {
        ...
        RsuCredentialController.RsuCredentialPatch rsuCredentialPatch = new RsuCredentialController.RsuCredentialPatch(
                nickname);
    ...
    void testDelete_Success() {
        ...
        RsuCredentialController.RsuCredentialDeleteRequest deleteRequest = new RsuCredentialController.RsuCredentialDeleteRequest(
                nickname);
