...
class AdminIntersectionControllerTest {
  ...
  @Nested
  @DisplayName("GET /intersections — list all intersections")
  ...
  @Nested
  @DisplayName("GET /intersections/{intersectionId} — single intersection")
  class GetSingleIntersection {

    @Test
    @DisplayName("returns 403 when no permissions are granted")
    void noPermissions_returns403() throws Exception {
      mockMvc.perform(get("/intersections/12109"))
        .andExpect(status().isForbidden());
    }
    ...
    void intersectionNotFound_returns404() throws Exception {
      ...
      mockMvc.perform(get("/intersections/99999"))
        .andExpect(status().isNotFound());
    }
  ...
  @Nested
  @DisplayName("PATCH /intersections — update intersection")
  class PatchIntersection {

    @Test
    @DisplayName("returns 403 when no permissions are granted")
    void noPermissions_returns403() throws Exception {
      mockMvc.perform(patch("/intersections")
  ...
  @Nested
  @DisplayName("DELETE /intersections — delete intersection")
  class DeleteIntersection {

    @Test
    @DisplayName("returns 403 when no permissions are granted")
    void noPermissions_returns403() throws Exception {
      mockMvc.perform(delete("/intersections")
