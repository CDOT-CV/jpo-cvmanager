...
class SnmpCredentialControllerTest {
    ...
    void testCreateSnmpCredential_Success()
        ...
        us.dot.its.jpo.ode.api.models.postgres.tables.Organization mockOrganization = mock(
                us.dot.its.jpo.ode.api.models.postgres.tables.Organization.class);
        when(mockOrganization.getId()).thenReturn(orgId);
        snmpCredential.setOwnerOrganization(mockOrganization);

        SnmpCredentialDTO expected = new SnmpCredentialDTO(null, nickname, username, password, orgId);

        when(mockSnmpCredentialManagementService.create(request)).thenReturn(snmpCredential);
        snmpCredentialController = new SnmpCredentialController(mockSnmpCredentialManagementService,
    ...
    @Test
    void testCreateSnmpCredential_Failure_AlreadyExists()
            throws SnmpCredentialManagementService.SnmpCredentialAlreadyExistsException, EntityNotFoundException {
        // Arrange
        String nickname = "nickname";
        String username = "username";
        ...
        SnmpCredentialController.SnmpCredentialCreateRequest request = new SnmpCredentialController.SnmpCredentialCreateRequest(
                nickname, username, password, orgId);
        when(mockSnmpCredentialManagementService.create(request))
                .thenThrow(SnmpCredentialManagementService.SnmpCredentialAlreadyExistsException.class);
        snmpCredentialController = new SnmpCredentialController(mockSnmpCredentialManagementService,
                snmpCredentialMapper);

        // Act & Assert
        assertThrows(SnmpCredentialManagementService.SnmpCredentialAlreadyExistsException.class,
                () -> snmpCredentialController.createSnmpCredential(request));
    }

    @Test
    void testCreateSnmpCredential_Failure_OrganizationNotFound()
            throws SnmpCredentialManagementService.SnmpCredentialAlreadyExistsException, EntityNotFoundException {
        // Arrange
        String nickname = "nickname";
        String username = "username";
    ...
    void testGetByNickname_Success() throws EntityNotFoundException {
        ...
        SnmpCredentialController.SnmpCredentialGetRequest request = new SnmpCredentialController.SnmpCredentialGetRequest(
                nickname);
        ...
        SnmpCredentialDTO expected = new SnmpCredentialDTO(mockRsuCredentialId, nickname, username, password,
                mockOrganizationId);
    ...
    void testUpdate_Success() throws EntityNotFoundException {
        ...
        SnmpCredentialDTO expected = new SnmpCredentialDTO(mockRsuCredentialId, nickname, username, updatedPassword,
                mockOrganizationId);
    ...
    void testDeleteByNickname_Success() throws EntityNotFoundException {
        ...
        SnmpCredentialController.SnmpCredentialDeleteRequest request = new SnmpCredentialController.SnmpCredentialDeleteRequest(
                nickname);
