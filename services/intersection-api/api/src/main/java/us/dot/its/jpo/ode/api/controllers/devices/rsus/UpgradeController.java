...
public class UpgradeController {
    ...
    public ResponseEntity<Map<String, FirmwareUpgradeResultDto>> startUpgrade(
        ...
        List<String> unauthorizedRsus = permissionService.findUnauthorizedRsus(body.getRsuIps(), "OPERATOR");
        if (!unauthorizedRsus.isEmpty()) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN,
                    "Organization does not own the following RSUs: " + String.join(", ", unauthorizedRsus) + ". No RSUs Upgraded.");
        }
