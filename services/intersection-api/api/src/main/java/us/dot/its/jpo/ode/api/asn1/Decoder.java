...
public interface Decoder {
    ...
    /**
     * This function adds metadata and transforms the included string into an
     * OdeAsn1Data Object
     * 
    ...
    /**
     * This Method takes in an XML string containing a J2735 message format, and
     * returns an equivalent JSON object representing the same J2735 message.
     * 
