...
public class AdminIntersectionController {
    ...
    public IntersectionListResponse getAllIntersections(
        ...
        log.info("GET /intersections. organization={}", organization);
    ...
    public IntersectionSingleResponse getIntersection(
        ...
        log.info("GET /intersections/{}. organization={}", intersectionId, organization);
    ...
    public void patchIntersection(@RequestBody @Validated IntersectionPatch patch) {
        ...
        log.info("PATCH /intersections. origIntersectionId={}", patch.getOrigIntersectionId());
    ...
    public void deleteIntersection(
        ...
        log.info("DELETE /intersections. intersectionId={}", intersectionId);
