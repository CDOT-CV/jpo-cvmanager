...
public class PcapController {
  ...
  @Operation(summary = "Convert PCAP UPER Hex",
      description =
          "Convert standard binary pcap data to JSON array of {@link TimestampedMessageFrameList}. "
   ...
   * <p>
   * Performs the call to the decoder endpoint asynchronously, without blocking a server thread
   * </p>
   *
  ...
  @Operation(summary = "Convert Hex UPER to JSON",
      description =
