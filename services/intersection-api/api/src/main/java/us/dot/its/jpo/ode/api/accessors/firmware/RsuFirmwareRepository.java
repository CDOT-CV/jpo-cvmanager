...
/**
 * Repository for RSU firmware operations
 * Delegates to shared firmware service with RSU-specific device type
 */
@Component
public class RsuFirmwareRepository {

    @Autowired
    private FirmwareService firmwareService;

    private static final String DEVICE_TYPE = "RSU";

    /**
     * Add RSU firmware version with upgrade rules
     * 
    ...
    /**
     * Get all RSU firmware files
     * 
     * @return List of RSU firmware files with rules
     */
