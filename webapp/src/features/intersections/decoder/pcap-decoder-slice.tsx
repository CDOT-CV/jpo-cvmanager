...
export const updateAllDataOnMap = createAsyncThunk(
  'pcapDecoder/updateAllDataOnMap',
...
export const pcapDecoderModeToggled = createAsyncThunk(
  ...
  async (enabled: boolean, { getState, dispatch }) => {
    ...
    console.log('pcapDecoder/decoderModeToggled')
...
export const selectData = (state: RootState) => state.pcapDecoder.value.data
...
export const selectSelectedMapMessage = (state: RootState) => state.pcapDecoder.value.selectedMapMessage
export const selectSelectedBsms = (state: RootState) => state.pcapDecoder.value.selectedBsms
export const selectCurrentBsms = (state: RootState) => state.pcapDecoder.value.currentBsms
